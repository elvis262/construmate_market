...
@section('page_header')
    <div class="container-fluid">
        ...
        <button class="btn btn-danger btn-add-new selected-items" data-toggle="modal" data-target="#delete_modal" data-name='remove-order'>Supprimer la Sélection</button>
            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <form method="get" class="form-search" action = {{ route('commande.remove') }}>
                            @csrf
                            <div id="search-input">
                                <div class="col-2">
                                    ...
                                    @foreach ($commandes as $commande)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions" colspan="5">
                                                <button class="btn btn-sm btn-danger pull-right change-state" data-order={{$commande->id}} data-toggle="modal" data-target="#delete_modal">
                                                    Supprimer
                                                </button>  
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-bubble"></i> Voulez vous supprimer cette/Ces commande(s) commande comme traitée?</h4>
                </div>
