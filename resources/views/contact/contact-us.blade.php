...
@section('content')
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Contactez Nous Pour Toutes Vos Question</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col-lg-7">
                <div class="contact-form">
                    @include('includes.flash')
                    <form name="sentMessage" id="contactForm" novalidate="novalidate" action="{{route('contact.contactUs')}}" method="post">
                        @csrf
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Sujet"
                                required="required" data-validation-required-message="Entrez un sujet" name="subject"/>
                        </div>
